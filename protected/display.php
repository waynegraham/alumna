...
// this if runs if they have not pushed the modify button
...
{
?>
<center><h3>Your query returned <? echo mysql_num_rows($result); ?> records<br>Choose a record to edit</h3></center>
<?
}
?>
</td>
...
?>
<a href="iph.php">Input new search criteria</a>
</center>
</td>
</tr>
...
<center><input type="submit" name="modify" value="Modify this record">
<input type="submit" name="remod" value="Back to search results">  <h3> OR </h3><a href="iph.php">Input new search criteria</a>
</center>
</td>
</tr>
</form>
...
$connection=mysql_connect("localhost", "alumnaAdmin", "alumna%adm%orion");
mysql_select_db("eos8d_alumna", $connection);
$query1="select * from iph where accessionNumber = " . $rec_num2;
$result1 = mysql_query($query1, $connection);
// $fin_result1 = mysql_fetch_array($result1, MYSQL_NUM);
$i1=1;
...
$fin_result[$i1] = $_GET[$field[$i1]];
$i1++;
}
$i2 = 1;
while ($i2 <= 47)
{
$resp_num = "response" . $i2;
$resp_mod[$i2] = $_GET[$resp_num];
$i2++;
}
$i = 1;
...
while ($i_mod <=47)
{
$chk_query = "select * from openresponses where accessionNumber = " . $rec_num2 . " and QuestionNumber = " . $i_mod;
$chk_response = mysql_query($chk_query, $connection);
$chk_num = mysql_num_rows($chk_response);
if ($chk_num == 0 && $resp_mod[$i_mod] != '')
{
$mod_query2 = "insert into openresponses set accessionNumber = " . $rec_num2 . ", QuestionNumber = " . $i_mod . ", Response = '" . $resp_mod[$i_mod] . "'";
$mod_result = mysql_query($mod_query2, $connection);
echo $mod_query2;
if (!$mod_result)
{
...
{
$mod_query2 = "update openresponses set Response = '" . $resp_mod[$i_mod] . "' where accessionNumber = " . $rec_num2 . " and QuestionNumber = " . $i_mod;
$mod_result = mysql_query($mod_query2, $connection);
if (!$mod_result)
{
echo mysql_errno($connection) . ": " . mysql_error($connection);
...
<input type="hidden" name="submitsearch" value="Yes">
...
<input type="submit" name="remod" value="Back to these search results">  <h3> OR </h3><a href="iph.php">Input new search criteria</a>
</center>
</form>
<?  
