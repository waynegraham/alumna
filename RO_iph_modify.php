...
?>
<form method="GET" action="ROtest.php">
...
<option selected value=""></option>
<?
$result_prog1 = mysql_query ($prog3_query, $connection);
while ($option_prog3 = mysql_fetch_row($result_prog3))
{
?>
<option value="<? echo $option_prog3[0]; ?>"><? echo $option_prog3[0]; ?></option>
<?
}
?>
</select>
